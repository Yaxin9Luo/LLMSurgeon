...
#
# Usage:
#   bash starcoder_minkpp_ddp.sh [NUM_GPUS]
#   
# Examples:
#   bash starcoder_minkpp_ddp.sh 4    # Use 4 GPUs
#   bash starcoder_minkpp_ddp.sh      # Use all available GPUs
...
torchrun --nproc_per_node=$NUM_GPUS \
  baseline_method/src/labelshift/run_minkpp_threshold_starcoder_ddp.py \
  ...
  --trust_remote_code \
  --output_dir out \
  --run_name minkpp_threshold_starcoder_ddp
